    ...
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="bg-pk-surface border border-pk-bg-secondary rounded-3xl p-6 md:p-10 space-y-8 text-pk-text-main/90 leading-relaxed shadow-sm">
        <section>
          ...
          <p>
            When you visit Primkart Kitchenware, we automatically collect certain information about your device, including information about your web browser, IP address, time zone, and some of the cookies that are installed on your device. Additionally, as you browse the Site, we collect information about the individual web pages or products that you view.
          </p>
        </section>
